...
export const stringsFr: Record<StringKey, string> = {
  ...
  expeditionTypeMiningDesc: 'Mission chronométrée : revenir avec des pièces + données de recherche.',
  expeditionTypeMiningExplain: 'L’équipage part pour une durée fixe (2–10 min selon la difficulté). Au retour : pièces (production × durée) et données de recherche. Pas de nouvelle planète. Coût inférieur au Scout.',

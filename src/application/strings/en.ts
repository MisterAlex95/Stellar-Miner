...
export const stringsEn = {
  ...
  prestigeReward1: 'Prestige 1: +7% production (level) plus +1% per planet discovered and +0.5% per research node completed (banked at reset). Unlocks click bonuses: Lucky / Super Lucky / Critical, Combo, Research +% click. Before prestige 1, each click gives only 1 coin.',
  prestigeRewardLevelFormat: 'Prestige {level}: +{prod}% production (level + planets + research). Unlocks: +{click}% click forever.',

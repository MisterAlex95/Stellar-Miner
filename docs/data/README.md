...
| Modules | `src/data/modules.json` | [modules-schema.md](modules-schema.md) | Module catalog (planetTypes, modules with cost, production, crew, optional affinity per planet type) |

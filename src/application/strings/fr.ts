...
export const stringsFr: Record<StringKey, string> = {
  ...
  progressionWelcomeBody: 'Cliquez sur l’astéroïde (ou Espace) pour miner des pièces. Objectif : développer votre opération en achetant des modules, en engageant de l’équipage et en découvrant des planètes. Minez jusqu’à pouvoir vous offrir votre première module !',
  ...
  progressionCrewBody: 'Engagez des astronautes pour booster la production (+2 % par astronaute). Les meilleures modules nécessitent de l’équipage ; vous dépensez des astronautes à l’achat. Engagez votre premier astronaute quand vous pouvez (2 500 ⬡).',
  progressionQuestTitle: 'Quêtes',
  progressionQuestBody: 'Terminez des quêtes pour des pièces et récompenses bonus. Chaque quête a un objectif (ex. miner X pièces, acheter des modules). Réclamez sous 5 minutes pour un bonus de série.',
  progressionPlanetsTitle: 'Planètes',
  progressionPlanetsBody: 'Envoyez des astronautes en expédition pour découvrir de nouvelles planètes (+4 % production chacune). Certains peuvent mourir ; si tous meurent, la planète n’est pas découverte. Vous pouvez aussi ajouter des emplacements aux planètes existantes.',
  progressionEventsTitle: 'Événements aléatoires',
  progressionEventsBody: "L'espace réserve des surprises. Des événements aléatoires vont désormais parfois augmenter ou réduire votre production pendant un court moment. Surveillez les badges d'événements !",

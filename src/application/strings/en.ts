...
export const stringsEn = {
  ...
  expeditionTypeMiningDesc: 'Timed mission: return with coins + research data.',
  expeditionTypeMiningExplain: 'Crew leaves for a set duration (2–10 min by difficulty). On return they bring back coins (based on your production × duration) and research data. No new planet. Lower cost than Scout.',

...
| **Boundaries** | - I **never** write secrets into code. - I **never** hallucinate functionality not specified in `/docs`. - I **never** rely on timestamps for logic. - I escalate to the user when I am blocked, missing secrets, or face architectural ambiguity. |

...
export const stringsEn = {
  ...
  progressionWelcomeBody: 'Click the asteroid (or press Space) to mine coins. Your goal: grow your mining operation by buying modules, hiring crew, and expanding to new planets. Start by mining until you can afford your first module!',
  progressionUpgradesTitle: 'Modules',
  progressionUpgradesBody: 'Spend coins to buy equipment that produces coins automatically. Each module adds production per second. Some modules are more effective on specific planet types (Rocky, Desert, Ice, Volcanic, Gas)—install them on matching planets for a bonus. You can buy the same module multiple times; each goes on a planet slot. Start with a Mining Robot (45 ⬡).',
  progressionCrewTitle: 'Crew',
  progressionCrewBody: 'Hire astronauts to boost your production (+2% per astronaut). Better modules require crew to operate—you spend astronauts when you buy those modules. Hire your first astronaut when you can afford it (2,500 ⬡).',
  progressionQuestTitle: 'Quests',
  progressionQuestBody: 'Complete quests for bonus coins and rewards. Each quest has a target (e.g. mine X coins, buy modules). Claim within 5 minutes of completion for a streak bonus. Check the Quest section above.',

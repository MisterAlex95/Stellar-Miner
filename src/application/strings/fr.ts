...
export const stringsFr: Record<StringKey, string> = {
  ...
  dashboardAddSlot: 'Ajouter un emplacement pour placer plus d’améliorations',
  dashboardHireCrew: 'Engager des astronautes pour la prochaine amélioration',
  ...
  crewHint: 'Recrutez des astronautes (sans métier au début). Débloquez Mineur, Scientifique, Pilote, Médecin et Ingénieur via la Recherche pour des bonus. Certaines améliorations coûtent du crew (assigné à l’équipement). Réinitialisé au Prestige.',
  ...
  emptyUpgradesText: 'Gagnez 30 pièces pour débloquer les améliorations.',
  ...
  planetDetailUpgrades: 'Améliorations installées',
  planetDetailNoUpgrades: 'Aucune amélioration installée.',

...
export const stringsEn = {
  ...
  appSubtitle: 'Mine coins. Buy modules. Conquer the belt.',
  settings: 'Settings',
  ...
  resetConfirmDesc: 'Coins, planets, modules, crew, achievements and all progress will be lost. This cannot be undone.',
  cancel: 'Cancel',
  resetAll: 'Reset all',
  ...
  gotIt: 'Got it',
  coins: 'Coins',
  coinsTitle: 'Your current coins. Spend them on modules, crew, and planets.',
  ...
  prestigeRules: 'Prestige resets your run (coins, planets, modules, crew, research) but you keep your Prestige level forever.\n\n- Each level gives +4% production on all future runs (stacking).\n- You need to reach the prestige coin threshold (shown in the section) to unlock the button.\n- Use it when progress feels slow — the permanent bonus will make the next run faster.',
  crew: 'Crew',
  astronautsLabel: 'Astronauts',
  crewHint: 'Hire astronauts (no job at first). Unlock Miner, Scientist, Pilot, Medic and Engineer via Research for bonuses. Some modules cost crew (assigned to equipment). Resets on Prestige.',
  crewRules: 'Astronauts give bonuses and are needed to buy some modules. Everything here resets on Prestige.\n\nFree crew (the numbers in the cards) give passive bonuses:\n- Miners: +2% production each.\n- Scientists: +2% research success chance each (capped).\n- Pilots: −8% expedition duration each (max 50% shorter).\n- Medics: −2% expedition death chance each.\n- Engineers: +1.2% production each.\n\nWhen you buy a module that costs crew, that many astronauts are assigned to equipment — they no longer count as "free" but still count toward your total. Capacity comes from planets and housing (+2 per module). Veterans are expedition survivors and give +0.5% production each.',
  ...
  housingNoSlot: 'No free slot on any planet. Add a slot or use slots for modules.',
  housingBuilt: 'built',
  ...
  upgrades: 'Modules',
  upgradesHint: 'Each card shows tier, best planet types (chips), name, production and cost. Buy modules to boost production; install on matching planet types for a bonus. Each uses one slot; some cost crew. Add slots or new planets to place more.',
  upgradesRules: 'Modules increase your production (coins per second). Each planet has a limited number of slots (6 on the first planet).\n\n- You can buy the same module multiple times; each copy uses one slot on the planet you choose.\n- Some modules perform better on certain planet types: install them on matching planets for a bonus.\n- Some modules also cost crew: when you buy them, that many astronauts are assigned to equipment (see Crew section).\n- To place more modules: add slots to a planet or discover new planets.',
  ...
  researchTree3DHint: 'Drag to pan, scroll to zoom, click a node to attempt.',
  researchTree3DZoomIn: 'Zoom in',
  researchTree3DZoomOut: 'Zoom out',
  researchViewList: 'List',
  researchView3D: '3D tree',
  researchRules: 'The research tree unlocks permanent bonuses (+% production, +% click, and effects like "this module no longer costs crew").\n\n- Unlock nodes by attempting them: each attempt costs coins and has a success chance. If it fails, the coins are lost and you can try again.\n- Scientists in your crew increase the success chance (capped).\n- All research progress resets on Prestige.',
  ...
  debugAddPlanet: '+1 planet',
  debugOpenBalance: 'Balance tool',
  debugF3Hint: 'F3 to toggle',
  firstPrestigeToast: 'First prestige!',
  firstUpgradeToast: 'First module!',
  ...
  expeditionMiningSuccess: 'Mining run complete! +{coins} ⬡ and {survivors} crew returned.',
  expeditionRescueSuccess: 'Rescue complete! {rescued} crew recovered, {survivors} returned.',
  expeditionRescueRange: '{min}–{max} rescued',
  ...
  chartDescProduction: 'Empire production rate (coins per second) at each sample. Affected by modules, planets, prestige, events.',
  ...
  researchSlotFree: '{n} module(s) no longer use a slot',
  researchCrewFree: '{n} module(s) no longer require crew',
  ...
  researchUnlocksCrewRetrain: 'Unlocks: Crew retrain',
  researchExpeditionDurationPercent: 'Expedition duration {pct}%',
  researchExpeditionDeathChancePercent: 'Expedition death chance {pct}%',
  researchHousingCapacityBonus: '+{n} crew capacity',
  ...
  eventChoiceRiskAstronaut: 'Risk 1 astronaut — ×{mult} production for {sec}s',
  eventChoiceRisk2Astronauts: 'Risk 2 astronauts — ×{mult} production for {sec}s',
  eventChoiceDoNothing: 'Do nothing',
  eventChoiceShortBurst: 'Short burst',
  eventChoiceLongHaul: 'Long haul',
  eventChoiceRideWave: 'Ride the wave',
  eventChoiceStaySafe: 'Stay safe',
  eventChoiceQuickBoost: 'Quick boost',
  eventChoiceSteadyGain: 'Steady gain',
  eventChoiceStorm: 'Ride the storm',
  eventChoiceCalm: 'Wait for calm',
  eventChoicePeek: 'Peek',
  eventChoiceIgnore: 'Ignore',
  eventChoicePayRepair: 'Pay to repair',
  eventChoiceBreakModule: 'Cannibalize a module',
  eventChoiceSufferLeak: 'Leave it (penalty)',
  eventChoiceBribe: 'Pay for priority',
  eventChoiceSacrificeModule: 'Sacrifice a module',
  eventChoiceEffectSummary: '×{mult} production for {sec}s',
  eventChoiceEffectNone: 'No effect',
  eventChoiceCostCoins: '−{n} ⬡',
  eventChoiceCostModule: '−{n} module(s)',
  eventChoiceSuccessChance: '{pct}% success',
  eventChoicePrompt: 'Choose an option:',
  ...
  archiveLogTab: 'Log',
  archiveSetsTab: 'Module sets',
  archiveSetsIntro: 'Set bonuses you have unlocked. Complete required modules on a planet to discover more.',
  archiveSetsEmpty: 'No set bonuses discovered yet. Install matching modules on a planet to unlock.',
  setBonusPlanetCondition: 'Planet: {types}',
  archiveFilterAll: 'All',
  archiveFilterCategory: 'Category',
  archiveSearchPlaceholder: 'Search…',
  archiveFilterNoResults: 'No entries match the filters.',
  archiveSetsFilterPlanet: 'Planet type',
  archiveSetsSearchPlaceholder: 'Search by name…',
  archivePlanetTypeAny: 'Any',
  archivePlanetTypeRocky: 'Rocky',
  archivePlanetTypeVolcanic: 'Volcanic',
  archivePlanetTypeDesert: 'Desert',
  archivePlanetTypeIce: 'Ice',
  archivePlanetTypeGas: 'Gas',
  ...
  buyUpgradeTitle: 'Install {name} · {cost}',
  needCrewToBuy: 'Need more crew to install this module.',
  needCoinsForOne: 'Need {cost} to install at least one.',
  noSlotsOrCoins: 'No free slots or not enough coins/crew to install more.',
  toPlanet: 'To',
  assignToPlanet: 'Assign to planet',
  upgradeChoosePlanetInstallTitle: 'Choose planet to install module on',
  upgradeChoosePlanetUninstallTitle: 'Choose planet to uninstall module from',
  upgradeChoosePlanetSelect: 'Select',
  upgradeChoosePlanetExpand: 'Show details',
  upgradeChoosePlanetCollapse: 'Hide details',
  upgradeChoosePlanetInstalledOnPlanet: 'modules of this type on this planet',
  upgradeChoosePlanetRecommendedHint: 'Best planet type for this module — higher production.',
  tierLabel: 'Tier {n}',
  crewBadgeTitle: 'Cost in astronauts (spent when you install)',
  crewCostShort: '{n} crew',
  upgradeUsesSlot: '1 slot',
  upgradeNoSlot: 'No slot',
  upgradePlanetAffinityTitle: 'Production by planet type (install on matching planets for a bonus)',
  moduleBestOn: 'Best on: {types}',
  slots: 'slots',
  upgrading: 'Installing...',
  upgradingCount: 'Installing {current}/{total}',
  uninstallingCount: 'Uninstalling {current}/{total}',
  addSlotBtn: '+1 slot · {cost} ⬡',
  addSlotTooltip: 'Add one module slot · {cost} ⬡',
  needCoinsForSlot: 'Need {cost} ⬡ to add a slot',
  sendExpeditionBtn: 'Send expedition ({cost} ⬡ + {n} crew)',
  sendExpeditionBtnLabel: 'Send expedition',
  ...
  expeditionSelectType: 'Mission type',
  expeditionTypeScout: 'Scout',
  expeditionTypeScoutDesc: 'Discover a new planet.',
  expeditionTypeScoutExplain: 'Send your crew to explore and discover a new planet. Success adds a planet and research data; survivors become veterans. Cost scales with your current planet count.',
  expeditionTypeMining: 'Mining',
  expeditionTypeMiningDesc: 'Timed mission: return with coins + research data. More miners = more coins.',
  expeditionTypeMiningExplain: 'Crew leaves for a set duration (2–10 min by difficulty). On return they bring back coins (based on your production × duration) and research data. Including miners in the crew increases coin rewards. No new planet. Lower cost than Scout.',
  expeditionTypeRescue: 'Rescue',
  expeditionTypeRescueDesc: 'Safer run: recover 2–3 crew + research data.',
  expeditionTypeRescueExplain: 'Safer mission to recover stranded crew. Lower death risk. On success: team returns + 2–3 rescued astronauts (capped by housing) + 1 research data. No new planet. Cost is half of a Scout.',
  expeditionTierDurationOnly: 'Duration',
  expeditionTierDifficultyOnly: 'Difficulty',
  expeditionNewSolarSystem: 'New solar system',
  expeditionNewSolarSystemHint: 'This system is full (4 planets). The next expedition heads to a new system — cost is higher.',
  expeditionNewSolarSystemTooltipLine: 'Next stop: a new solar system (higher cost).',
  expeditionNextNewSystemLabel: 'Next: new solar system (higher cost).',
  ...
  crewInModules: '{n} astronaut(s) are on equipment — they were assigned when you bought modules that cost crew.',
  crewSegmentRole: '{n} {role}',
  crewSegmentEquipment: '{n} on equipment',
  crewSegmentFree: '{n} free slot(s)',
  crewRetrainLabel: 'Retrain crew',
  crewRetrainFrom: 'From',
  crewRetrainTo: 'To',
  crewRetrainBtn: 'Retrain · {cost} ⬡',
  crewOperatesHint: 'Hire crew to buy tier 3+ modules (each costs coins + astronauts).',
  crewOperatesNext: '{free} available. Next: {name} costs {n} crew.',
  crewOperatesUpgrades: '{n} module(s) operated by crew.',
  ...
  prestigeConfirmGainEstimate: 'This run: +{levelPct}% (level) +{planetPct}% (planets) +{researchPct}% (research) = +{totalPct}% total.',
  prestigeRunBonusTitle: 'Run bonus (pick one)',
  prestigeChoiceClickBonus: '+10% Click Production',
  prestigeChoiceClickBonusFlavor: 'Mine clicks reward 10% more coins this run.',
  prestigeChoiceProductionBonus: '+10% Total Production',
  prestigeChoiceProductionBonusFlavor: 'All production is 10% higher this run.',
  prestigeChoiceExpeditionSpeed: 'Expedition Speed +15%',
  prestigeChoiceExpeditionSpeedFlavor: 'Expeditions finish 15% faster this run.',
  eachPerSecond: '+{n}/s',
  totalPerSecond: 'Total: +{n}/s',
  needCoinsToBuy: 'Need {cost}{crew} to install.',
  needCoinsAndCrew: 'Need {cost} + {crew} and a free slot.',
  maxBuyTooltip: 'Install as many as you can with current slots',
  locked: 'Locked',
  ...
  debugUpgradesTotal: 'Modules total',
  debugRunDuration: 'Run duration',
  debugNextEventIn: 'Next event in',
  debugActiveEvents: 'Active events',
  debugCopySave: 'Copy save',
  progressionWelcomeTitle: 'Welcome to Stellar Miner',
  progressionWelcomeBody: 'Click the asteroid (or press Space) to mine coins.\n\nYour goal: grow your mining operation by buying modules, hiring crew, and expanding to new planets. Start by mining until you can afford your first module!',
  progressionUpgradesTitle: 'Modules',
  progressionUpgradesBody: 'Spend coins to buy equipment that produces coins automatically. Each module adds production per second.\n\nSome modules are more effective on specific planet types (Rocky, Desert, Ice, Volcanic, Gas)—install them on matching planets for a bonus.\n\nYou can buy the same module multiple times; each goes on a planet slot. Start with a Mining Robot (45 ⬡).',
  progressionCrewTitle: 'Crew',
  progressionCrewBody: 'Hire astronauts to boost your production (+2% per astronaut).\n\nBetter modules require crew to operate—you spend astronauts when you buy those modules. Hire your first astronaut when you can afford it (2,500 ⬡).',
  progressionQuestTitle: 'Quests',
  progressionQuestBody: 'Complete quests for bonus coins and rewards.\n\nEach quest has a target (e.g. mine X coins, buy modules). Claim within 5 minutes of completion for a streak bonus. Check the Quest section above.',
  progressionPlanetsTitle: 'Planets',
  progressionPlanetsBody: 'Send astronauts on expeditions to discover new planets (+4% production each).\n\nSome may die during the mission; if all die, the planet is not discovered. You can also add slots to existing planets.',
  progressionEventsTitle: 'Random events',
  progressionEventsBody: 'Space is full of surprises.\n\nRandom events will now occasionally boost or reduce your production for a short time. Watch the event badges and plan around them!',
  progressionResearchTitle: 'Scientific Research',
  progressionResearchBody: 'Skill tree: attempt to unlock nodes for +% production and +% click.\n\nEach attempt can succeed or fail (coins lost on failure). Resets on Prestige.',
  progressionPrestigeTitle: 'Prestige',
  progressionPrestigeBody: 'When you reach 5,000,000 coins you can Prestige: reset coins and planets to gain +4% production per prestige level forever.\n\nUse it to progress faster on each new run.',
  ...
  planetDetailUpgrades: 'Installed modules',
  planetDetailNoUpgrades: 'No modules installed yet.',

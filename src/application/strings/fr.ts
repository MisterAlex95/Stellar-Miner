...
export const stringsFr: Record<StringKey, string> = {
  ...
  expeditionMiningSuccess: 'Mission minière terminée ! +{coins} ⬡ et {survivors} équipage de retour.',
  expeditionRescueSuccess: 'Sauvetage réussi ! {rescued} équipage récupéré, {survivors} de retour.',
  expeditionRescueRange: '{min}–{max} secourus',
  ...
  researchExpeditionDurationPercent: 'Durée d’expédition {pct} %',
  researchExpeditionDeathChancePercent: 'Risque de mort en expédition {pct} %',
  researchHousingCapacityBonus: '+{n} capacité d’équipage',
  ...
  eventChoiceRiskAstronaut: 'Risquer 1 astronaute — ×{mult} prod. pendant {sec}s',
  eventChoiceRisk2Astronauts: 'Risquer 2 astronautes — ×{mult} prod. pendant {sec}s',
  eventChoiceDoNothing: 'Ne rien faire',
  eventChoiceShortBurst: 'Court sursaut',
  eventChoiceLongHaul: 'Longue durée',
  eventChoiceRideWave: 'Surfer la vague',
  eventChoiceStaySafe: 'Rester à couvert',
  eventChoiceQuickBoost: 'Boost rapide',
  eventChoiceSteadyGain: 'Gain stable',
  eventChoiceStorm: 'Prendre la tempête',
  eventChoiceCalm: 'Attendre l\'accalmie',
  eventChoicePeek: 'Jeter un œil',
  eventChoiceIgnore: 'Ignorer',
  eventChoicePayRepair: 'Payer pour réparer',
  eventChoiceBreakModule: 'Cannibaliser un module',
  eventChoiceSufferLeak: 'Laisser (malus)',
  eventChoiceBribe: 'Payer pour priorité',
  eventChoiceSacrificeModule: 'Sacrifier un module',
  eventChoiceEffectSummary: '×{mult} prod. pendant {sec}s',
  eventChoiceEffectNone: 'Aucun effet',
  eventChoiceCostCoins: '−{n} ⬡',
  eventChoiceCostModule: '−{n} module(s)',
  eventChoiceSuccessChance: '{pct} % de réussite',
  eventChoicePrompt: 'Choisissez une option :',
  ...
  archiveLogTab: 'Journal',
  archiveSetsTab: 'Sets de modules',
  archiveSetsIntro: 'Bonus de sets que vous avez débloqués. Complétez les modules requis sur une planète pour en découvrir plus.',
  archiveSetsEmpty: 'Aucun bonus de set découvert. Installez les modules correspondants sur une planète pour débloquer.',
  setBonusPlanetCondition: 'Planète : {types}',
  archiveFilterAll: 'Tout',
  archiveFilterCategory: 'Catégorie',
  archiveSearchPlaceholder: 'Rechercher…',
  archiveFilterNoResults: 'Aucune entrée ne correspond aux filtres.',
  archiveSetsFilterPlanet: 'Type de planète',
  archiveSetsSearchPlaceholder: 'Rechercher par nom…',
  archivePlanetTypeAny: 'Tous',
  archivePlanetTypeRocky: 'Rocheuse',
  archivePlanetTypeVolcanic: 'Volcanique',
  archivePlanetTypeDesert: 'Désert',
  archivePlanetTypeIce: 'Glace',
  archivePlanetTypeGas: 'Gaz',
  ...
  sendExpeditionBtnLabel: 'Envoyer une expédition',
  ...
  expeditionSelectType: 'Type de mission',
  expeditionTypeScout: 'Éclaireur',
  expeditionTypeScoutDesc: 'Découvrir une nouvelle planète.',
  expeditionTypeScoutExplain: 'Envoyez l’équipage explorer pour découvrir une nouvelle planète. Succès = +1 planète et données de recherche ; les survivants deviennent vétérans. Coût selon le nombre de planètes.',
  expeditionTypeMining: 'Mining',
  expeditionTypeMiningDesc: 'Mission chronométrée : pièces + données de recherche. Plus de mineurs = plus de pièces.',
  expeditionTypeMiningExplain: 'L’équipage part pour une durée fixe (2–10 min selon la difficulté). Au retour : pièces (production × durée) et données de recherche. Inclure des mineurs dans l’équipage augmente les pièces rapportées. Pas de nouvelle planète. Coût inférieur au Scout.',
  expeditionTypeRescue: 'Sauvetage',
  expeditionTypeRescueDesc: 'Mission plus sûre : 2–3 équipage + donnée de recherche.',
  expeditionTypeRescueExplain: 'Mission plus sûre pour récupérer de l’équipage. Risque de mort réduit. Succès = retour de l’équipe + 2–3 astronautes secourus (plafonnés par le logement) + 1 donnée de recherche. Pas de nouvelle planète. Coût = moitié d’un Scout.',
  expeditionTierDurationOnly: 'Durée',
  expeditionTierDifficultyOnly: 'Difficulté',
  ...
  prestigeRunBonusTitle: 'Bonus de run (choisir un)',
  prestigeChoiceClickBonus: '+10 % production au clic',
  prestigeChoiceClickBonusFlavor: 'Les clics mine rapportent 10 % de pièces en plus cette run.',
  prestigeChoiceProductionBonus: '+10 % production totale',
  prestigeChoiceProductionBonusFlavor: 'Toute la production est +10 % cette run.',
  prestigeChoiceExpeditionSpeed: 'Vitesse expédition +15 %',
  prestigeChoiceExpeditionSpeedFlavor: 'Les expéditions finissent 15 % plus vite cette run.',
  eachPerSecond: '+{n}/s',
